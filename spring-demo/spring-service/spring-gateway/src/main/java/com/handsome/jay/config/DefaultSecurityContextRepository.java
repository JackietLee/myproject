        ...
        if (!CollectionUtils.isEmpty(headers)) {
            ...
            if (StringUtils.isNotEmpty(authorization)) {
                ...
                if (StringUtils.isNotEmpty(token)) {
                    Mono<Authentication> authenticationMono = tokenAuthenticationManager.authenticate(
                            new UsernamePasswordAuthenticationToken(token, null));
                    return authenticationMono.map(authentication -> new SecurityContextImpl(authentication));
