package com.jay.handsome.video;
...
public class Rtmp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String rtmpPath = "rtmp://localhost:1935/liveapp/test";
        String rtspPath = "rtsp://wowzaec2demo.streamlock.net/vod/mp4:BigBuckBunny_115k.mp4";
